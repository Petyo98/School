...
public class TeachersController {
    ...
    ModelAndView showTeachers(Model model){
        ...
        List<Teacher> teacherList =teachersService.findAll();
    ...
    public String addTeacher (@RequestParam(value = "name", required=false) String name,
        ...
        Teacher teacher = new Teacher(name,school112,subject123);
        teachersService.addTeacher(teacher);
        List<Teacher> school112List = teachersService.findAll();
