...
public class Subject123 {
    ...
    @OneToMany(targetEntity= Teacher.class,mappedBy="subject123", cascade = CascadeType.PERSIST, orphanRemoval = true)
    private List<Teacher> teachers1s;

    public List<Teacher> getTeachers1s() {
        return teachers1s;
    }

    public void setTeachers1s(List<Teacher> teachers1s) {
